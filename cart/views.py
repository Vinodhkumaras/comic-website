...
# 1. C
@login_required
def addToCart(request, comic_id):
    this_comic = Comic.objects.get(id = comic_id)

    cart_item, created_at = CartItem.objects.get_or_create(comic = this_comic, user = request.user)
